...
RUN apt install -y git openssh-server libglib2.0-0 libgtk2.0-0 libgtk2.0-dev libgl1-mesa-glx rsync pssh vim tmux
...
RUN pip install ray[default] ray[tune] parallel-ssh tqdm
